				...
				<div className="px-24 grid md:grid-cols-2 gap-4 lg:grid-cols-3">
							...
							<div className="">
								<div className="flex">
									<img
										...
										alt="img"
									/>
									<div className="pl-5 pb-2 pt-8"></div>
								</div>
								...
								<a
									className="py-3 font-bold text-emerald-500"
									href="https://github.com/abeni3mul/BMS"
									target="_blank"
								>
									Github
								</a>
					...
					<div className="  border border-amber-500  rounded-lg">
						<div className="pl-5">
							...
							<a
								className="py-3 font-bold text-emerald-500"
								href="https://github.com/abeni3mul/casino"
								target="_blank"
							>
								Github
							</a>
					...
					<div className="  border border-amber-500  rounded-lg">
						<div className="pl-5">
							<div>
								...
								<a
									className="py-3 font-bold text-emerald-500"
									href="https://github.com/abeni3mul/hms"
									target="_blank"
								>
									Github
								</a>
					...
					<div className="  border border-amber-500  rounded-lg">
						<div className="pl-5">
							<div>
								...
								<a
									className="py-3 font-bold text-emerald-500"
									href="https://github.com/abeni3mul/blackJack"
									target="_blank"
								>
									Github
								</a>
					...
					<div className="  border border-amber-500  rounded-lg">
						<div className="pl-5">
							<div>
								...
								<a
									className="py-3 font-bold text-emerald-500"
									href="https://github.com/abeni3mul/number-prediction"
									target="_blank"
								>
									Github
								</a>
					...
					<div className="  border border-amber-500  rounded-lg ">
						<div className="pl-5">
							<div>
								...
								<a
									className="py-3 font-bold text-emerald-500"
									href="https://github.com/abeni3mul/stock-price-prediction"
									target="_blank"
								>
									Github
								</a>
